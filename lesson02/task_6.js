...
function declensionWord(num, words) {
    // Проверяет содержит ли число 1 в конце, но не содержит 11 в конце числа
    if ((num % 10 === 1) && (num % 100 !== 11)) {
        // При выполнении условия возвращает 0 по индексу слово из массива - 'рубль'
        return words[0];
    // Проверяет содержит ли число 2,3 или 4 в конце, но не содержит 12, 13 или 14 в конце числа
