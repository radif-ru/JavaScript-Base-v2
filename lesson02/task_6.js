...
function declensionWord(num, words) {
    // Проверяет содержит ли число 1 в конце, кроме тех, которые содержат 11 в конце числа
    if ((num % 10 === 1) && (num % 100 !== 11)) {
        // При выполнении условия возвращает 0 по индексу слово из массива - 'рубль'
        return words[0];
    // Все числа содержащие 2,3,4 в конце, кроме тех, которые содержат 12, 13, 14 в конце числа
    } else if ((num % 10 === 2 || num % 10 === 3 || num % 10 === 4)
        && (num % 100 !== 12 && num % 100 !== 13 && num % 100 !== 14)) {
        // При выполнении условия возвращает 1 по индексу слово из массива - 'рубля'
        return words[1]
    // Все остальные числа
    } else {
        // При выполнении условия возвращает 2 по индексу слово из массива - 'рублей'
        return words[2]
    }
}

//Универсализация функции.
